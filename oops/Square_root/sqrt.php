...
<html>
<head>
	<title>Squre root finder</title>
</head>
<body>
	<form method="post">
		<b>enter number to find square root</b><input type="text" name="sqrt"><input type="submit" name="find_sqrt">
	</form>
...
if(isset($_POST))
{
	...
	#print_r($arr1);
	echo "Square root of ".$find_sqrt." is ".implode("",$arr1);
}	
?>